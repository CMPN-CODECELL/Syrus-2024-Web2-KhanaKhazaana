        ...
        child: PageView.builder(
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () {
                // Navigate to the card details page and pass the necessary information
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CardDetailsPage(
                      name: demoCardData[index].name,
                      image: demoCardData[index].image,
              ...
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  // Calculate dynamic height for the image to fit entirely in the card
                  double cardHeight = MediaQuery.of(context).size.height * 0.3;
                  double imageHeight = cardHeight * (1 + 0.1 * gauss);
